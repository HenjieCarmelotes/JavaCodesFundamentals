...
public class MultiplicationQuiz {
     ...
     * the random numbers for the first and second operands of each multiplication
     * problem.  
    ...
    private static void administerQuiz(int[] firstNumbers, int[] secondNumbers, int[] userAnswers) {
    	...
    	for (int i = 0; i < 5; i++) {
            int questionNum = i + 1;
            System.out.printf("Question %2d:  What is %2d x %2d  ? ",
    ...
    private static void gradeQuiz(int[] firstNumbers, int[] secondNumbers, int[] userAnswers) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.printf("   Question %2d:  %2d x %2d  =  %2d.  ",
