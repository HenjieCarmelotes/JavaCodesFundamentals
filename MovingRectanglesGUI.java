 ...
 *  closes the window.
 */
public class MovingRectanglesGUI extends Application {
    ...
    public void drawFrame(GraphicsContext g, int frameNumber, double elapsedSeconds, int width, int height) {
        ...
        g.fillRect(0,0,width,height);  // Fill drawing area with yellow.
        ...
        g.setStroke(Color.YELLOW);  // Draw the rectangle outlines in red.
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Infinte Moving Rectangles");
        stage.show();
