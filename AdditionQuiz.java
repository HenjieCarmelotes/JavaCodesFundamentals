...
/**
 * This program administers a 5-question addition quiz to the user.  The numbers
 * addends are generated at random.  However, the numbers and the answers 
 * are restricted to one or 2-digits.
 * After asking the user the 5 questions, the computer grades the
