...
public class PoppingCirclesGUI extends Application {
	/**
    ...
    public void drawFrame(GraphicsContext g, int frameNumber, double elapsedSeconds, int width, int height) {
        ...
        colorSelector = (int)(6*Math.random());
        ...
        g.strokeOval( centerX - 5, centerY - 5, 10, 10 );
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Random Circle Pops");
        stage.show();
